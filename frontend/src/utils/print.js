...
.sig-line { border-top:1px solid #111; margin-bottom:6px; height:36px; }
...
export function printReport({ title, subtitle, columns, rows, summaryRows, dateRange, state, generatedBy, signatureLines }) {
...
<div class="page">
  <div class="header">
    ...
    <div>
      ...
      ${generatedBy ? `<div class="doc-sub">Generated By: ${esc(generatedBy)}</div>` : ''}
    </div>
  </div>
  ...
  ${signatureLines?.length ? `<div class="sig-section">${signatureLines.map(l => `<div class="sig-box"><div class="sig-line"></div><div class="sig-label">${esc(l)}</div></div>`).join('')}</div>` : ''}
  <div class="footer">
