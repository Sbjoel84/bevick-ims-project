...
const STATUS_COLORS = {
  ...
  delivered: 'bg-blue-950 text-blue-400',
      ...
      <div>
        ...
        {f.items.length === 0 ? (
          <button
            type="button"
            onClick={addRow}
            className="w-full border-2 border-dashed border-gray-700 hover:border-blue-600 rounded-xl py-6 text-gray-500 hover:text-blue-400 text-sm transition-colors flex flex-col items-center gap-1.5"
          >
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-800 rounded-xl divide-y divide-gray-700 text-sm">
              ...
              <div className="flex justify-between px-4 py-2.5 font-medium">
                <span className="text-gray-400">Estimated Value</span>
                <span className="text-blue-400 font-mono">{formatCurrency(selected.total || 0, currency)}</span>
              </div>
            </div>
            {selected.note && (
